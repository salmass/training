...
public class HibernateConfiguration {
	...
	static {
		try {
			...
			configuration.setProperty("hibernate.connection.url", "jdbc:mysql://localhost:3306/bankingapp");
			configuration.setProperty("hibernate.connection.username", "root");
			configuration.setProperty("hibernate.connection.password", "IDontKnow123!");
